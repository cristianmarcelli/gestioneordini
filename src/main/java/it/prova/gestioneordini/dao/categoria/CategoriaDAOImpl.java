...
public class CategoriaDAOImpl implements CategoriaDAO {
	...
	public List<String> findAllCodiciDiCategorieDiOrdiniEffettuatiAFebbraioDuemilaventidue() {
		TypedQuery<String> query = entityManager.createQuery("select distinct c.codice FROM Ordine o join o.articoli a join a.categorie c where o.dataSpedizione like '2022-02%'", String.class);
